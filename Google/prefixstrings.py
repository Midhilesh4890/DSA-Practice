"""Count inserted words sharing a requested prefix.

Question:
    Count inserted words sharing a requested prefix.

Approach:
    A trie stores at each node how many words pass through it.

Complexity:
    O(L) insertion/query time and O(total characters) space.
