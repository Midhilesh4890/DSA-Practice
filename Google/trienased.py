"""Find the shortest alphabet string absent from an input string.

Question:
    Find the shortest alphabet string absent from an input string.

Approach:
    Insert suffixes into a trie and BFS missing child edges by length.

Complexity:
    O(N^2) build time/space and O(A^L) search time.
