"""Find all videos transitively related by shared tags.

Question:
    Find all videos transitively related by shared tags.

Approach:
    Map tags to videos and join connected videos with disjoint-set union.

Complexity:
    O(V*T*alpha(V)) time and O(V*T) space.
