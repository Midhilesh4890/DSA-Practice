"""Decide whether cards can be partitioned into valid triples.

Question:
    Decide whether cards can be partitioned into valid triples.

Approach:
    Validate candidate triples and backtrack over unused cards.

Complexity:
    O(N!/(3!)^(N/3)) worst-case time and O(N) recursion space.
