"""Maintain manager and peer relationships and answer ancestry queries.

Question:
    Maintain manager and peer relationships and answer ancestry queries.

Approach:
    Disjoint sets group peers while parent links retain management structure.

Complexity:
    Near O(alpha(N)) peer updates; ancestry queries are O(H); O(N) space.
