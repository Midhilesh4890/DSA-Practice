"""Assign interns to apartment rooms while respecting preferences when possible.

Question:
    Assign interns to apartment rooms while respecting preferences when possible.

Approach:
    Partition apartments and people by sharing preference, then fill available rooms.

Complexity:
    O(A+P) time and O(A+P) space.
