"""Find the longest consecutive customer run a funded bank can serve.

Question:
    Find the longest consecutive customer run a funded bank can serve.

Approach:
    Use prefix sums plus range-minimum queries to find the first unaffordable transaction.
