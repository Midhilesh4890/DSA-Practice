"""Produce dictionary words as streamed letters become available.

Question:
    Produce dictionary words as streamed letters become available.

Approach:
    Track buffered character counts or a reverse trie and consume a matched word.

Complexity:
    O(W*A) per count-based update or O(L) trie suffix work; O(total word characters) space.
