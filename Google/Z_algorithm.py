"""Form the longest palindrome by joining pieces of two strings.

Question:
    Form the longest palindrome by joining pieces of two strings.

Approach:
    Prefix/Z-style palindrome matching evaluates compatible cut positions.

Complexity:
    O(N+M) intended time and O(N+M) space.
