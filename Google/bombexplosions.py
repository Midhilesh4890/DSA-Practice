"""Maximize radii collected while detonations remove nearby bombs.

Question:
    Maximize radii collected while detonations remove nearby bombs.

Approach:
    Process candidates and skip removed indices with a successor disjoint-set structure.

Complexity:
    O(N log N + N*alpha(N)) time and O(N) space.
